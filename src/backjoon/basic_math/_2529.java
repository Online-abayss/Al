...
//
//    static ArrayList<Integer> low_case_lst = new ArrayList<>();
...
//        map = new String[t];
//
//        dfs(br.readLine().split(" "), 0);
//
//        System.out.println(low_case_lst);
//
//
//
//    }
...
//        String sign = s[depth];
//
//        if (low_case_lst.isEmpty() && sign.equals("<")) {
//
//            visited[0] = true;
//
//            low_case_lst.add(0);
//
//
//        } else if (low_case_lst.isEmpty() && sign.equals(">")) {
//
//            visited[1] = true;
//
//            low_case_lst.add(1);
